<%@ Page Title="" Language="C#" MasterPageFile="~/Master-Admin.Master" AutoEventWireup="true" CodeBehind="BuilderAnnouncement.aspx.cs" Inherits="BN_HomeFinance.Admin.BuilderAnnouncement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-10 border-right">
                <div class="p-3 py-5 mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="text-right">Builder Announcement</h3>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 t-c mt-2">
                        <button type="button" class="btn btn-primary" onclick="LoadFrame();" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Preview
                        </button>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <iframe src="../StakeHolderList.aspx" id="frame" style="height: 100vh; width: 100%" onload="LoadImage()" title="Iframe Example"></iframe>
                </div>
    ...
    <script type="text/javascript">
        ...
        function LoadFrame() {
            ...
            if (header != "") {
                if (hasImage == "Yes")
                    document.getElementById("frame").src = "../<%= BN_HomeFinance.Helper.pg_StakeHolderList %>?<%= BN_HomeFinance.Helper.QueryStrings.UserTypeID.ToString() %>=3&<%= BN_HomeFinance.Helper.QueryStrings.PreviewMode.ToString()%>=1";
                else {
