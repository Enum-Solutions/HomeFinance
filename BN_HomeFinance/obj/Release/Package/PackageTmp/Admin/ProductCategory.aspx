<%@ Page Title="" Language="C#" MasterPageFile="~/Master-Admin.Master" AutoEventWireup="true" CodeBehind="ProductCategory.aspx.cs" Inherits="BN_HomeFinance.Admin.ProductCategory" %>
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-10 border-right">
                <div class="p-3 py-5 mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="text-right">Product Category</h3>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <asp:Label ID="lblProductCategory" runat="server" Text="Product Category"></asp:Label>
                        <asp:TextBox ID="txtProductCategory" CssClass="form-control" placeholder="Cateogry Name" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RFQImage" ControlToValidate="txtProductCategory" ValidationGroup="Val" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Required Field."></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-4 t-c">
                        ...
                        <asp:Button Text="Delete" ID="BtnDelete" runat="server" OnClick="Delete_Click" CssClass="btn btn-secondary" />
